...
Capture images using the PiCam v2.
Implement motion detection using image processing.
Compare edge computing vs cloud computing.
Develop a command-line security system.
